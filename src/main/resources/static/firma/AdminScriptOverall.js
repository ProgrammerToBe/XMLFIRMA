administratorFirme.service('tokenService', function(){
	var token = "";
...
administratorFirme.factory('httpRequestInterceptor',['tokenService', function (tokenService) {
...
administratorFirme.config(function ($httpProvider) {
...
administratorFirme.controller('Opsti', function($scope, $http, $compile, $timeout, $rootScope, $cookies, $window, tokenService){
